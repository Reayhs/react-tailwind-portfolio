    ...
    <>
      <div id="projects" className="projects  bg-[#171717] text-white py-10">
        ...
        <p className="text-center max-w-[1000px] lg:px-6 mx-auto text-[#939191]">
          My portfolio website features some of the projects I have worked on, including web applications,  API's, and content management systems. Each project highlights my skills in design, development, and testing.
